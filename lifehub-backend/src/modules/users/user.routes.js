...
import { getProfile, getSettings, updateProfile, updateSettings } from "./user.controller.js";

const router = Router();

router.get("/me", authenticate, authorize("CUSTOMER", "PROVIDER", "SHOPKEEPER", "DELIVERY", "BUSINESS", "ADMIN"), getProfile);
router.put("/me", authenticate, authorize("CUSTOMER", "PROVIDER", "SHOPKEEPER", "DELIVERY", "BUSINESS", "ADMIN"), updateProfile);
